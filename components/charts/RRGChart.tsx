        ...
        <div className="bg-[#111118] border border-[#1e1e2e] rounded-lg p-3">
            <Plot
                ...
                layout={{
                    ...
                    annotations: [
                        { xref: "paper", yref: "paper", x: 0.98, y: 0.98, text: "LEADING", showarrow: false, font: { color: "rgba(34, 197, 94, 0.4)", size: 40, weight: "bold" }, xanchor: "right", yanchor: "top" },
                        { xref: "paper", yref: "paper", x: 0.98, y: 0.02, text: "WEAKENING", showarrow: false, font: { color: "rgba(234, 179, 8, 0.4)", size: 40, weight: "bold" }, xanchor: "right", yanchor: "bottom" },
                        { xref: "paper", yref: "paper", x: 0.02, y: 0.02, text: "LAGGING", showarrow: false, font: { color: "rgba(239, 68, 68, 0.4)", size: 40, weight: "bold" }, xanchor: "left", yanchor: "bottom" },
                        { xref: "paper", yref: "paper", x: 0.02, y: 0.98, text: "IMPROVING", showarrow: false, font: { color: "rgba(59, 130, 246, 0.4)", size: 40, weight: "bold" }, xanchor: "left", yanchor: "top" },
                    ],
                    showlegend: false,
                    autosize: true,
                    height: 850,
